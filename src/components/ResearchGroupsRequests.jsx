...
function ResearchGroupRequests() {
    return (  
        <div className="container">
            <div className="card p-5 my-bg" style={{borderRadius: "25px"}}>
            <h2 className="card-header mb-5 p-4 title-bg" style={{borderRadius: "20px"}}>Group Requests</h2>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <h6>Do you want to Accept/Reject this group?</h6>
                </div>
...
export default ResearchGroupRequests;